/* Generated by Cython 0.19.2 on Thu Dec  5 09:43:05 2013 */
...
#endif
#include <math.h>
#define __PYX_HAVE__radix_sort
#define __PYX_HAVE_API__radix_sort
#include "string.h"
#include "stdio.h"
#include "stdlib.h"
 ...
 */
typedef __pyx_t_5numpy_int32_t __pyx_t_10radix_sort_int_t;
#if CYTHON_CCOMPLEX
  #ifdef __cplusplus
...
/* Module declarations from 'radix_sort' */
#define __Pyx_MODULE_NAME "radix_sort"
int __pyx_module_is_main_radix_sort = 0;

/* Implementation of 'radix_sort' */
static PyObject *__pyx_builtin_ValueError;
static PyObject *__pyx_builtin_range;
static PyObject *__pyx_builtin_RuntimeError;
static PyObject *__pyx_pf_10radix_sort_radix_sort(CYTHON_UNUSED PyObject *__pyx_self, long __pyx_v_keys, long __pyx_v_ps, int __pyx_v_offset, int __pyx_v_num_items); /* proto */
...
static char __pyx_k_15[] = "/users/roskar/cuda_render/radix_wrapper.pyx";
...
/* Python wrapper */
static PyObject *__pyx_pw_10radix_sort_1radix_sort(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyMethodDef __pyx_mdef_10radix_sort_1radix_sort = {__Pyx_NAMESTR("radix_sort"), (PyCFunction)__pyx_pw_10radix_sort_1radix_sort, METH_VARARGS|METH_KEYWORDS, __Pyx_DOCSTR(0)};
static PyObject *__pyx_pw_10radix_sort_1radix_sort(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  long __pyx_v_keys;
  long __pyx_v_ps;
  int __pyx_v_offset;
  ...
  __Pyx_RefNannySetupContext("radix_sort (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s__keys,&__pyx_n_s__ps,&__pyx_n_s__offset,&__pyx_n_s__num_items,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        case  1:
        if (likely((values[1] = PyDict_GetItem(__pyx_kwds, __pyx_n_s__ps)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("radix_sort", 1, 4, 4, 1); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 16; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  2:
        if (likely((values[2] = PyDict_GetItem(__pyx_kwds, __pyx_n_s__offset)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("radix_sort", 1, 4, 4, 2); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 16; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  3:
        if (likely((values[3] = PyDict_GetItem(__pyx_kwds, __pyx_n_s__num_items)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("radix_sort", 1, 4, 4, 3); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 16; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "radix_sort") < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 16; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
      }
    ...
    __pyx_v_keys = __Pyx_PyInt_AsLong(values[0]); if (unlikely((__pyx_v_keys == (long)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 16; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_ps = __Pyx_PyInt_AsLong(values[1]); if (unlikely((__pyx_v_ps == (long)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 16; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_offset = __Pyx_PyInt_AsInt(values[2]); if (unlikely((__pyx_v_offset == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 16; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_num_items = __Pyx_PyInt_AsInt(values[3]); if (unlikely((__pyx_v_num_items == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 16; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("radix_sort", 1, 4, 4, PyTuple_GET_SIZE(__pyx_args)); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 16; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  __pyx_L3_error:;
  __Pyx_AddTraceback("radix_sort.radix_sort", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_10radix_sort_radix_sort(__pyx_self, __pyx_v_keys, __pyx_v_ps, __pyx_v_offset, __pyx_v_num_items);
  __Pyx_RefNannyFinishContext();
  return __pyx_r;
}

/* "radix_wrapper.pyx":16
 * 
 * 
...
static PyObject *__pyx_pf_10radix_sort_radix_sort(CYTHON_UNUSED PyObject *__pyx_self, long __pyx_v_keys, long __pyx_v_ps, int __pyx_v_offset, int __pyx_v_num_items) {
  ...
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("radix_sort", 0);

  /* "radix_wrapper.pyx":17
 * 
 * def radix_sort(long keys, long ps, int offset, int num_items):
 *     return _radix_sort(<int*> keys, <Particle*> ps, offset, num_items)             # <<<<<<<<<<<<<<
 */
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_1 = PyFloat_FromDouble(radix_sort(((int *)__pyx_v_keys), ((struct Particle *)__pyx_v_ps), __pyx_v_offset, __pyx_v_num_items)); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 17; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 *     return _radix_sort(<int*> keys, <Particle*> ps, offset, num_items)
 */
  __pyx_k_tuple_13 = PyTuple_Pack(4, ((PyObject *)__pyx_n_s__keys), ((PyObject *)__pyx_n_s__ps), ((PyObject *)__pyx_n_s__offset), ((PyObject *)__pyx_n_s__num_items)); if (unlikely(!__pyx_k_tuple_13)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 16; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_k_tuple_13);
  __Pyx_GIVEREF(((PyObject *)__pyx_k_tuple_13));
  __pyx_k_codeobj_14 = (PyObject*)__Pyx_PyCode_New(4, 0, 4, 0, 0, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_k_tuple_13, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_15, __pyx_n_s__radix_sort, 16, __pyx_empty_bytes); if (unlikely(!__pyx_k_codeobj_14)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 16; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC initradix_sort(void); /*proto*/
PyMODINIT_FUNC initradix_sort(void)
#else
PyMODINIT_FUNC PyInit_radix_sort(void); /*proto*/
...
#endif
{
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit_radix_sort(void)", 0);
  ...
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4(__Pyx_NAMESTR("radix_sort"), __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #if PY_MAJOR_VERSION >= 3
  {
    ...
    if (!PyDict_GetItemString(modules, "radix_sort")) {
      if (unlikely(PyDict_SetItemString(modules, "radix_sort", __pyx_m) < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    }
  }
  #endif
  ...
  #endif
  if (__pyx_module_is_main_radix_sort) {
 ...
 *     return _radix_sort(<int*> keys, <Particle*> ps, offset, num_items)
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_10radix_sort_1radix_sort, NULL, __pyx_n_s__radix_sort); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 16; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s__radix_sort, __pyx_t_1) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 16; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
 ...
 */
  ...
  __Pyx_XDECREF(__pyx_t_1);
  if (__pyx_m) {
    __Pyx_AddTraceback("init radix_sort", __pyx_clineno, __pyx_lineno, __pyx_filename);
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init radix_sort");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if PY_MAJOR_VERSION < 3
